...
const RECOMMENDATION_REASONS = Object.freeze({
  'direct-travel': {
    [AGE_BUCKETS.TWENTIES]: '20대는 여행과 이동 계획이 늘기 쉬워, 여행 중 생기는 변수에 대비하는 상품으로 추천합니다.',
    default: ({ ageLabel }) => `${ageLabel}에 여행 일정이 있다면 출발 전에 확인하기 좋은 상품입니다.`,
  },
  'direct-driver': {
    [AGE_BUCKETS.TWENTIES]: '20대는 운전을 시작하거나 이동 범위가 넓어지는 경우가 많아, 운전 중 사고에 대비하는 상품으로 추천합니다.',
    [AGE_BUCKETS.THIRTIES]: '30대는 출퇴근과 일상 이동으로 운전 시간이 늘기 쉬워, 운전자 상품을 함께 추천합니다.',
    [AGE_BUCKETS.FORTIES]: '40대는 가족 이동과 업무 이동이 함께 늘기 쉬워, 운전 중 사고에 대비하는 상품으로 추천합니다.',
    default: ({ ageLabel }) => `${ageLabel}에 운전이나 차량 이동이 잦다면 확인하기 좋은 상품입니다.`,
  },
  'direct-dental': {
    [AGE_BUCKETS.TWENTIES]: '20대는 바쁜 일정으로 치과 관리를 미루기 쉬워, 치과 치료 부담을 확인하는 상품으로 추천합니다.',
    [AGE_BUCKETS.THIRTIES]: '30대는 일상 관리와 치료 일정이 함께 늘기 쉬워, 치아 상품을 함께 추천합니다.',
    default: ({ ageLabel }) => `${ageLabel}에는 치과 치료와 구강 관리 비용을 함께 점검하는 상품으로 추천합니다.`,
  },
  'medical-indemnity': {
    [AGE_BUCKETS.TWENTIES]: '20대는 병원 이용이나 갑작스러운 치료비 부담을 미리 살펴두면 좋아, 실손의료보험을 함께 추천합니다.',
    [AGE_BUCKETS.THIRTIES]: '30대는 일상 의료비와 가족 생활비를 함께 고려할 시기라, 실제 부담한 의료비를 점검하는 실손의료보험을 추천합니다.',
    default: ({ ageLabel }) => `${ageLabel}에 병원비 부담을 기본으로 준비하고 싶다면 확인하기 좋은 상품입니다.`,
  },
  'direct-cancer': {
    [AGE_BUCKETS.FORTIES]: '40대부터는 주요 질병 대비를 더 구체적으로 점검할 시기라, 암 상품을 우선 추천합니다.',
    [AGE_BUCKETS.FIFTIES]: '50대는 주요 질병 보장을 더 꼼꼼히 확인하는 경우가 많아, 암 상품을 우선 추천합니다.',
    [AGE_BUCKETS.SIXTIES_PLUS]: '60대 이상은 주요 질병 보장을 먼저 점검하는 경우가 많아, 암 상품을 함께 추천합니다.',
    default: () => '건강 보장을 먼저 살펴보고 싶을 때 기본으로 확인하기 좋은 상품입니다.',
  },
  'signature-women-health': {
    default: () => '여성으로 선택한 경우, 여성 질환과 여성암 관련 보장을 함께 살펴보는 상품으로 추천합니다.',
  },
  'direct-fire': {
    [AGE_BUCKETS.TWENTIES]: '20대는 자취·독립·이사처럼 주거 환경이 바뀌기 쉬워, 생활 공간을 위한 화재 상품을 추천합니다.',
    ...
    default: ({ ageLabel }) => `${ageLabel}에는 거주 공간의 화재와 생활위험을 함께 점검하는 상품으로 추천합니다.`,
  },
  'comprehensive-health': {
    [AGE_BUCKETS.FORTIES]: '40대부터는 암·뇌·심장 같은 주요 질병을 함께 점검할 필요가 커져, 종합 건강 상품을 추천합니다.',
    [AGE_BUCKETS.FIFTIES]: '50대는 여러 건강 위험을 한 번에 점검하고 싶은 경우가 많아, 종합 건강 상품을 우선 추천합니다.',
    [AGE_BUCKETS.SIXTIES_PLUS]: '60대 이상은 주요 건강 위험을 폭넓게 점검하는 상품을 우선 추천합니다.',
    default: ({ ageLabel }) => `${ageLabel}에 건강 보장을 폭넓게 보고 싶다면 확인하기 좋은 상품입니다.`,
  },
  'senior-care': {
    [AGE_BUCKETS.SIXTIES_PLUS]: '60대 이상은 치료 이후 간병비와 가족 부담까지 고려할 일이 많아져, 노후 간병 준비를 확인하는 상품으로 추천합니다.',
    default: ({ ageLabel }) => `${ageLabel}에 간병비와 장기 치료 이후 생활 부담을 함께 살펴보고 싶다면 추천합니다.`,
  },
  'direct-golf': {
    default: () => '골프 활동을 한다면 라운딩 중 생기는 비용 부담에 대비하는 상품으로 추천합니다.',
  },
});
...
export function recommendationReason(product, profile) {
  ...
  return `${ageLabel}에 ${product.category} 상품을 확인하기 좋은 조건이라 추천합니다.`;
}
